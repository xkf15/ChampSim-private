#!/bin/bash
#SBATCH --job-name=base_misses      # create a short name for your job
...
# $1 trace name
BIN=/tigress/kaifengx/ChampSim_qemu/ChampSim-private/bin/champsim_tage_small-replay-lessmemory_detailed_misses_his
# cd /tigress/kaifengx/ChampSim
# BP_STATES=/tigress/kaifengx/ChampSim_qemu/ChampSim-private/branch/tage/states/
...
$BIN --warmup_instructions ${WARMUP_INSN} --simulation_instructions ${SIM_INSN} -c ${TRACE}  > ${OUTPUT_DIR}${TRACE_NAME}_detailed_misses_reasons_his_tagesmall_base.out
