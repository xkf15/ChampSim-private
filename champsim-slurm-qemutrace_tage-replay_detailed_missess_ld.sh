...
# $1 bp states trace name
# $2 trace name
TRACE_NAME=$2 # nokvm-2023-11-13_-_23-41-55-chameleon.trace
BIN=/tigress/kaifengx/ChampSim_qemu/ChampSim-private/bin/champsim_tage-replay_detailed_misses_ld
BP_STATES=/scratch/gpfs/kaifengx/tage-replay_states/${1}_morememory.states
...
$BIN --warmup_instructions ${WARMUP_INSN} --simulation_instructions ${SIM_INSN} -c -s ${BP_STATES} ${TRACE}  > ${OUTPUT_DIR}${TRACE_NAME}_load_states_every1000atonce_morememory.out
