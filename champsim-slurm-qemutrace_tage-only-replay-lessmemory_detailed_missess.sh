...
# $1 trace name
BIN=/tigress/kaifengx/ChampSim_qemu/ChampSim-private/bin/champsim_tage-only-replay-lessmemory_detailed_misses
...
$BIN --warmup_instructions ${WARMUP_INSN} --simulation_instructions ${SIM_INSN} -c ${TRACE}  > ${OUTPUT_DIR}${TRACE_NAME}_detailed_misses_reasons_tageonly_base.out
