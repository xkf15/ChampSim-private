...
BIN=/tigress/kaifengx/ChampSim_qemu/ChampSim-private/bin/champsim_alderlake
...
$BIN --warmup_instructions ${WARMUP_INSN} --simulation_instructions ${SIM_INSN} -c ${TRACE}  > ${OUTPUT_DIR}${TRACE_NAME}_alderlake_tage_base.out
