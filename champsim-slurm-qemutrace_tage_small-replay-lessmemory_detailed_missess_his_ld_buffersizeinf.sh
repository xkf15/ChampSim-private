...
# $1 load states
# $2 trace name
BIN=/tigress/kaifengx/ChampSim_qemu/ChampSim-private/bin/champsim_tage_small-replay-lessmemory_detailed_misses_his_ld_buffersizeinf
...
$BIN --warmup_instructions ${WARMUP_INSN} --simulation_instructions ${SIM_INSN} -c -s ${BP_STATES} ${TRACE} > ${OUTPUT_DIR}${TRACE_NAME}_detailed_misses_reasons_his_tagesmall_base_ld_buffersizeinf.out
