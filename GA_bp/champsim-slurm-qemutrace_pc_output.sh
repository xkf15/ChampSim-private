...
BIN=/tigress/kaifengx/ChampSim/bin/champsim_branchonly_pc_output
...
$BIN --warmup_instructions ${WARMUP_INSN} --simulation_instructions ${SIM_INSN} -c -b ${BP_STATES}insn -n $1 ${TRACE} > ${BP_STATES}pc_output.out
