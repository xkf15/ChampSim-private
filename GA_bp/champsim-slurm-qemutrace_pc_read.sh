...
BIN=/tigress/kaifengx/ChampSim/bin/champsim_branchonly_pc_read
...
$BIN --warmup_instructions ${WARMUP_INSN} --simulation_instructions ${SIM_INSN} -c -b ${BP_STATES}insn -n $1 ${TRACE} > ${BP_STATES}pc_2ndtrace_read.out
