...
BIN=/tigress/kaifengx/ChampSim/bin/champsim_branchonly_user_iter_noaddrrandom
...
$BIN --warmup_instructions ${WARMUP_INSN} --simulation_instructions ${SIM_INSN} -c -b ${BP_STATES}insn -n $1 ${TRACE} > ${BP_STATES}useronly_iter_noaddrrandom_${1}.out
