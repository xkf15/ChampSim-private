...
BIN=/tigress/kaifengx/ChampSim/bin/champsim_branchonly_user_ld
# cd /tigress/kaifengx/ChampSim
BP_STATES=/tigress/kaifengx/ChampSim/branch/tage/states_useronly/
TRACE=/scratch/gpfs/kaifengx/nokvm-2023-06-26_-_19-16-36-imageprocessing_test.trace
WARMUP_INSN=100000000
SIM_INSN=900000000

$BIN --warmup_instructions ${WARMUP_INSN} --simulation_instructions ${SIM_INSN} -c -b ${BP_STATES}insn -n $1 ${TRACE} > ${BP_STATES}useronly_ld_difftrace_${1}.out
