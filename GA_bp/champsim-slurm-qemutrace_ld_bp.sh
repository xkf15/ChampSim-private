...
BIN=/tigress/kaifengx/ChampSim/bin/champsim_branchonly_ld
...
$BIN --warmup_instructions ${WARMUP_INSN} --simulation_instructions ${SIM_INSN} -c -b ${BP_STATES}insn ${TRACE} > ${BP_STATES}bp_ld.out
