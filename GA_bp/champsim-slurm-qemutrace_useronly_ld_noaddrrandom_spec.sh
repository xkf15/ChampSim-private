#!/bin/bash
#SBATCH --job-name=LD_bp_kx      # create a short name for your job
...
# $2 benchmark number
# $3 trace_ld
BIN=/tigress/kaifengx/ChampSim/bin/champsim_branchonly_user_ld_noaddrrandom_spec
...
mkdir ${BP_STATES}
$BIN --warmup_instructions ${WARMUP_INSN} --simulation_instructions ${SIM_INSN} -c -b ${BP_STATES}insn -n $1 ${TRACE_LD} > ${BP_STATES}useronly_ld_noaddrrandom_spec_${2}_${1}.out
