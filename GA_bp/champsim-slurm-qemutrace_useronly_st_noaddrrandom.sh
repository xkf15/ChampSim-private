...
BIN=/tigress/kaifengx/ChampSim/bin/champsim_branchonly_user_st_noaddrrandom
...
$BIN --warmup_instructions ${WARMUP_INSN} --simulation_instructions ${SIM_INSN} -c -b ${BP_STATES}insn -n $1 ${TRACE} > ${BP_STATES}useronly_st_noaddrrandom_${1}.out
